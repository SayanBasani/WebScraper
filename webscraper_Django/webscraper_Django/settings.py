...
SECRET_KEY = 'django-insecure-x$=bxxf82m7%2hgi$)nh7!=^+a_x=1bp1u&d15^w%w)ioopl=!'
...
ROOT_URLCONF = 'webscraper_Django.urls'
...
WSGI_APPLICATION = 'webscraper_Django.wsgi.application'
